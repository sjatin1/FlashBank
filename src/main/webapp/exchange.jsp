...
<head>
  ...
  <title>Foreign Exchange page</title>
  <style>
  input[type=submit] {
    ...
    <header>
      ...
      <nav class="navbar">
        ...
        <ul class="navbar-nav">
          ...
          <form action="inrexchange.jsp">
         <button class="btn-primary">Exchange With INR</button>
</form>
...
<div class="align">
	...
	<label>Select Foreign Currency Type</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<select name="cur_type" required>
		...
		<input type="submit" value ="exchange with foreign currency"><br><br>
