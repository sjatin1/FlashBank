...
<form action="breakfd.jsp">
         <button class="btn-primary">Break FD</button>
</form>
...
<main>
      ...
      <!--
        - #HOME SECTION
      -->
<form action="FixedDep" method="post">

     <div class="credentials">
	<center>
	<span>FD_Name : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="fd_name">&nbsp;&nbsp;&nbsp;<br><br></span>
	<span>Amount : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input min=1 type="number" name="amt"><br><br></span>
